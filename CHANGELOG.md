...
* fixes bug 'unable to disable alarm reminder notification' (#650).
* updates translation to Norwegian (nb) (#648 by FTno).
* updates translation to Traditional Chinese (zh_TW) (#646 by James Liu).
* updates translation to Simplified Chinese (zh_CN) (#645 by sr093906, #646 by James Liu).
