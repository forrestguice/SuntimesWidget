...
public class SuntimesConfigActivity2_1x3 extends SuntimesConfigActivity2
{
    public SuntimesConfigActivity2_1x3()
    {
        super();
    }
    ...
    {
        Intent updateIntent = new Intent(context, SuntimesWidget2_1x3.class);
    ...
    protected Intent themeEditorIntent(Context context)
    {
        ...
        intent.putExtra(WidgetThemeConfigActivity.PARAM_PREVIEWID, WidgetThemeConfigActivity.PREVIEWID_SUNPOS_1x3);
        return intent;
    }
    ...
    protected View[] getPrimaryWidgetModeViews() {
        return new View[] { label_3x1mode, spinner_3x1mode };  // TODO
    }

    @Override
    protected View[] getSecondaryWidgetModeViews() {
        return new View[] { label_1x1mode, spinner_1x1mode, label_2x1mode, spinner_2x1mode,
                //label_3x1mode, spinner_3x1mode,    // TODO
                label_3x2mode, spinner_3x2mode, label_3x3mode, spinner_3x3mode };
    }
