...
public class WorldMapView extends android.support.v7.widget.AppCompatImageView
{
    ...
    /**
     * EquiazimuthalProjection
     */
    public static class EquiazimuthalProjection extends WorldMapProjection
    {
        /**
     ...
     */
    public static class EquirectangularProjection extends WorldMapProjection
    {
        public Bitmap makeBitmap(SuntimesRiseSetDataset data, int w, int h, WorldMapOptions options)
        {
            long bench_start = System.nanoTime();
    ...
    {
        private WorldMapProjection projection = new EquirectangularProjection();
        private WorldMapOptions options = new WorldMapOptions();
