...
/**
 * This task writes one or more bitmaps to zip file.
 */
public class BitmapExportTask extends ExportTask
{
    public BitmapExportTask(Context context, String exportTarget)
    {
        super(context, exportTarget);
        setZippedOutput(zippedOutput);
    }
    public BitmapExportTask(Context context, String exportTarget, boolean useExternalStorage, boolean saveToCache)
    {
