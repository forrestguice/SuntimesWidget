...
public class WorldMapWidgetSettings
{
    ...
    public static enum WorldMapWidgetMode implements WidgetSettings.WidgetModeDisplay
    {
        ...
        MOLLWEIDE_SIMPLE("Mollweide", MAPTAG_3x3, R.layout.layout_widget_sunpos_3x3_2, new SunPosLayout_3X2_0(), false, 0, 0, "Mollweide", PROJ4_MOLL, WorldmapBackgroundContract.PROJECTION_MOLL),
        ;
