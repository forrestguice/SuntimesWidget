...
public class LocationConfigView extends LinearLayout
{
    ...
    public com.forrestguice.suntimeswidget.calculator.Location getLocation()
    {
    ...
    private GetFixUI getFixUI_editMode = new GetFixUI()
    {
        ...
        {
            DecimalFormat formatter = com.forrestguice.suntimeswidget.calculator.Location.decimalDegreesFormatter();
    ...
    private void updateViews(com.forrestguice.suntimeswidget.calculator.Location location)
    {
    ...
    protected void loadSettings(Context context)
    {
        ...
        com.forrestguice.suntimeswidget.calculator.Location location = WidgetSettings.loadLocationPref(context, appWidgetId);
    ...
    protected void loadSettings(Context context, Bundle bundle )
    {
        ...
        com.forrestguice.suntimeswidget.calculator.Location location;
        if (longitude != null && latitude != null)
        {
            if (altitude != null)
                location = new com.forrestguice.suntimeswidget.calculator.Location(label, latitude, longitude, altitude);
            else location = new com.forrestguice.suntimeswidget.calculator.Location(label, latitude, longitude);
    ...
    {
        com.forrestguice.suntimeswidget.calculator.Location location = getLocation();
    ...
    private Spinner.OnItemSelectedListener onCustomLocationSelected = new Spinner.OnItemSelectedListener()
    {
        public void onItemSelected(AdapterView<?> parent, View view, int position, long id)
        {
            ...
            {
                updateViews(new com.forrestguice.suntimeswidget.calculator.Location(cursor.getString(1), cursor.getString(2), cursor.getString(3), cursor.getString(4)));
            }
        }
        public void onNothingSelected(AdapterView<?> parent) {}
    };
