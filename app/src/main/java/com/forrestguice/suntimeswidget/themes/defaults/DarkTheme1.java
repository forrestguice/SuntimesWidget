...
public class DarkTheme1 extends  DarkTheme
{
    ...
    public DarkTheme1(Context context)
    {
        ...
        this.themeDisplayString = context.getString(R.string.themes_widgetThemes_dark);
    ...
    public static ThemeDescriptor themeDescriptor(Context context)
    {
        if (THEMEDEF_DESCRIPTOR == null) {
            THEMEDEF_DESCRIPTOR = new ThemeDescriptor(THEMEDEF_NAME, context.getString(R.string.themes_widgetThemes_dark), THEMEDEF_VERSION, THEMEDEF_BACKGROUND.name(), Color.DKGRAY);
        }
