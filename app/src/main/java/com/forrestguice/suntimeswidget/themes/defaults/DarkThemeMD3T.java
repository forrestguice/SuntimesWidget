...
public class DarkThemeMD3T extends DarkThemeMD3
{
    public static final String THEMEDEF_NAME = "darkmd3_translucent";
    ...
    public DarkThemeMD3T(Context context)
    {
        ...
        this.themeDisplayString = context.getString(R.string.themes_widgetThemes_dark_md3_translucent);
    ...
    public static ThemeDescriptor themeDescriptor(Context context)
    {
        if (THEMEDEF_DESCRIPTOR == null) {
            THEMEDEF_DESCRIPTOR = new ThemeDescriptor(THEMEDEF_NAME, context.getString(R.string.themes_widgetThemes_dark_md3_translucent), THEMEDEF_VERSION, THEMEDEF_BACKGROUND.name(), Color.DKGRAY);
        }
