...
public class EquinoxDialog extends BottomSheetDialogBase
{
    ...
    protected void shareItem(Context context, @Nullable Intent itemData)
    {
        ...
        if (itemMode != null && itemMillis != -1L)
        {
            ...
            String itemDisplay = context.getString(R.string.format_share, itemMode, utils.calendarDateTimeDisplayString(context, itemTime, showTime, showSeconds).toString());
