...
public class AlarmEditViewHolder extends RecyclerView.ViewHolder
{
    ...
    protected void initTooltips()
    {
        ...
        TooltipCompat.setTooltipText(edit_note);
    }
    ...
    {
        String noAction = context.getString(R.string.actions_configLabel_action_item_none);
        ...
        String desc = context.getString(R.string.actions_configLabel_action_item_desc, actionDesc);
    ...
    public static CharSequence displayEvent(Context context, AlarmClockItem item)
    {
        ...
        if (eventString != null)
        {
            ...
            if (summary != null)
            {
                ...
                summary = context.getString(R.string.event_configLabel_alarmitem_desc, summary);
                String displayString = context.getString(R.string.event_configLabel_alarmitem, eventItem.getTitle(), summary);
