...
public class MoonWidget0_3x2 extends MoonWidget0
{
    ...
    {
        MoonWidget0.updateAppWidget(context, new AppWidgetManagerWrapper(appWidgetManager), appWidgetId, MoonWidget0_3x2.class, getMinSize(context), new MoonLayout_3x2_0());
    }
