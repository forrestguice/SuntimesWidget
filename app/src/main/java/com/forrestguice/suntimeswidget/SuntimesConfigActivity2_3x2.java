...
public class SuntimesConfigActivity2_3x2 extends SuntimesConfigActivity2
{
    ...
    {
        SuntimesWidget2_3x2.updateAppWidget(context, AppWidgetManager.getInstance(context), appWidgetId, SuntimesWidget2_3x2.class, minWidgetSize(context), new SunPosLayout_3X2_0());
    }
