...
public class SunLayout_2x1_0 extends SunLayout
{
    ...
    {
        if (fill) {
            return chooseSunLayout(R.layout.layout_widget_2x1_0_align_fill, R.layout.layout_widget_2x1_01_align_fill, data, order);
        } else {
            switch (position) {
                ...
                case 5: case 0: default: return chooseSunLayout(R.layout.layout_widget_2x1_0, R.layout.layout_widget_2x1_01, data, order);
            }
        }
    }
