...
public class SuntimesLayout_1x1_1 extends SuntimesLayout
{
    ...
    public void themeViews(Context context, RemoteViews views, SuntimesTheme theme)
    {
        ...
        Bitmap sunriseIcon = SuntimesUtils.drawableToBitmap(context, R.drawable.ic_sunrise_large0, true, 32, 8, false, theme.getSunriseIconColor(), theme.getSunriseIconStrokeColor(), theme.getSunriseIconStrokePixels(context));
