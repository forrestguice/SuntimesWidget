...
public class SuntimesLayout_1x1_2 extends SuntimesLayout
{
    ...
    public void themeViews(Context context, RemoteViews views, SuntimesTheme theme)
    {
        ...
        Bitmap sunsetIcon = SuntimesUtils.drawableToBitmap(context, R.drawable.ic_sunset_large0,true, 32, 8, false, theme.getSunsetIconColor(), theme.getSunsetIconStrokeColor(), theme.getSunsetIconStrokePixels(context));
