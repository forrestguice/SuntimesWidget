...
import static com.forrestguice.suntimeswidget.settings.AppThemes.AppThemeInfo;
...
public class AppSettings
{
    ...
    public static int setTheme(Activity activity, String appTheme)
    {
        ...
        AppCompatDelegateHelper.setDefaultNightMode(AppThemes.loadThemeInfo(appTheme).getDefaultNightMode());
        return themeResID;
    }
    ...
    {
        if (themeName != null) {
            AppThemeInfo themeInfo = AppThemes.loadThemeInfo(themeName);
            TextSize textSize = AppThemeInfo.getTextSize(themeName);

            String themeName1 = getThemeOverride(context, themeInfo);
            if (themeName1 != null) {
                AppThemeInfo themeInfo1 = AppThemes.loadThemeInfo(themeName1);
    ...
    public static String getThemeOverride(Context context, String appTheme) {
        return getThemeOverride(context, AppThemes.loadThemeInfo(appTheme));
    }
    @Nullable
    ...
    @NonNull
    public static AppThemes.AppThemeInfo loadThemeInfo(Context context) {
        return AppThemes.loadThemeInfo(AppSettings.loadThemePref(context));
    }
