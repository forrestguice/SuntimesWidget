 ...
 * results.
 */
public class GetFixUI2 extends GetFixUI
{
    ...
    public GetFixUI2(EditText nameUI, EditText latUI, EditText lonUI, ProgressBar progress, ImageButton getFixButton)
    {
    ...
    {
        locationLatUI.setEnabled(false);
        locationLonUI.setEnabled(false);
        locationNameUI.setEnabled(false);
    }
