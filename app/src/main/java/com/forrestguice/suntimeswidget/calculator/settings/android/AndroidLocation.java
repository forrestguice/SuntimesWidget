...
{
    public static Location createLocation(String label, android.location.Location location)
    {
        ...
        return new Location(label, formatter.format(rawLatitude), formatter.format(rawLongitude), rawAltitude + "");
    }
}
