...
public class WidgetListActivityTest extends SuntimesActivityTestBase
{
    ...
    public static class WidgetListActivityRobot extends ActivityRobot<WidgetListActivityRobot>
    {
        ...
        public WidgetListActivityRobot showOverflowMenu(Context context) {
        ...
        public WidgetListActivityRobot clickOverflowMenu_help() {
            onView(withText(R.string.configAction_help)).inRoot(isPlatformPopup()).perform(click());
            return this;
        }
        public WidgetListActivityRobot clickOverflowMenu_about() {
