...
public class WidgetSettingsTest extends SuntimesActivityTestBase
{
    ...
    public void test_actionLaunchPref()
    {
        ...
        WidgetActions.saveActionLaunchPref(context, appWidgetId, null, value2, WidgetActions.LaunchType.ACTIVITY.name(), action2, data2, mime2, extras2, title2);
        ...
        WidgetActions.saveActionLaunchPref(context, appWidgetId, null, value1, WidgetActions.LaunchType.ACTIVITY.name(), action1, data1, mime1, extras1, title1);
