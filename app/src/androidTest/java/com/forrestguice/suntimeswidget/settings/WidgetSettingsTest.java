...
public class WidgetSettingsTest extends SuntimesActivityTestBase
{
    ...
    public void test_actionLaunchPref()
    {
        ...
        String pref2_mime = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_DATATYPE);
        String pref2_extra = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_EXTRAS);
        ...
        String pref1_mime = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_DATATYPE);
        String pref1_extra = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_EXTRAS);
        ...
        WidgetSettings.deleteActionLaunchPref(context, appWidgetId, null);
        String pref0_value = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, null);
        String pref0_action = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_ACTION);
        String pref0_data = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_DATA);
        String pref0_mime = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_DATATYPE);
        String pref0_extra = WidgetSettings.loadActionLaunchPref(context, appWidgetId, null, WidgetSettings.PREF_KEY_ACTION_LAUNCH_EXTRAS);
