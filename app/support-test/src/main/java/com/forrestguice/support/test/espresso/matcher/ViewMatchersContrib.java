...
public class ViewMatchersContrib
{
    ...
    public static Matcher<View> withTextAsDate(final SimpleDateFormat[] allowedFormats, final Calendar calendar0, final long tolerance, boolean allowSurroundingText)
    {
        return new TypeSafeMatcher<View>()
        {
